...
//
    ...
    jQuery.extend({
        ...
        isPlainObject: function (obj) {
            ...
            // Support: IE<9 0="" 1="" 2009="" handle="" iteration="" over="" inherited="" properties="" before="" own="" properties.="" if="" (support.ownlast)="" {="" for="" (key="" in="" obj)="" return="" hasown.call(obj,="" key);="" }="" are="" enumerated="" firstly,="" so="" to="" speed="" up,="" last="" one="" is="" own,="" then="" all="" own.="" key="==" undefined="" ||="" },="" type:="" function="" (obj)="" (obj="=" null)="" obj="" +="" "";="" typeof="" "object"="" "function"="" ?="" class2type[="" tostring.call(obj)="" ]="" :="" obj;="" evaluates="" a="" script="" global="" context="" workarounds="" based="" on="" findings="" by="" jim="" driscoll="" http:="" weblogs.java.net="" blog="" archive="" 09="" 08="" eval-javascript-global-context="" globaleval:="" (data)="" (data="" &&="" jquery.trim(data))="" we="" use="" execscript="" internet="" explorer="" an="" anonymous="" that="" window="" rather="" than="" jquery="" firefox="" (="" window.execscript="" window[="" "eval"="" ].call(window,="" data);="" )(data);="" convert="" dashed="" camelcase;="" used="" the="" css="" and="" data="" modules="" microsoft="" forgot="" hump="" their="" vendor="" prefix="" (#9572)="" camelcase:="" (string)="" string.replace(rmsprefix,="" "ms-").replace(rdashalpha,="" fcamelcase);="" nodename:="" (elem,="" name)="" elem.nodename="" elem.nodename.tolowercase()="==" name.tolowercase();="" args="" internal="" usage="" only="" each:="" (obj,="" callback,="" args)="" var="" value,="" i="0," length="obj.length," isarray="isArraylike(obj);" (args)="" (isarray)="" (;="" <="" length;="" i++)="" value="callback.apply(obj[" ],="" args);="" (value="==" false)="" break;="" else="" (i="" special,="" fast,="" case="" most="" common="" of="" each="" i,="" obj[="" ]);="" native="" string.trim="" wherever="" possible="" trim:="" trim="" !trim.call("\ufeff\xa0")="" (text)="" text="=" null="" ""="" trim.call(text);="" otherwise="" our="" trimming="" functionality="" ).replace(rtrim,="" "");="" results="" makearray:="" (arr,="" results)="" ret="results" [];="" (arr="" !="null)" (isarraylike(object(arr)))="" jquery.merge(ret,="" arr="==" "string"="" [="" );="" push.call(ret,="" arr);="" ret;="" inarray:="" arr,="" i)="" len;="" (arr)="" (indexof)="" indexof.call(arr,="" elem,="" i);="" len="arr.length;" math.max(0,="" 0;="" skip="" accessing="" sparse="" arrays="" arr[="" elem)="" i;="" -1;="" merge:="" (first,="" second)="" j="0," while="" (j="" len)="" first[="" i++="" j++="" ];="" support:="" ie<9="" workaround="" casting="" .length="" nan="" arraylike="" objects="" (e.g.,="" nodelists)="" (len="" (second[j]="" undefined)="" first.length="i;" first;="" grep:="" (elems,="" invert)="" callbackinverse,="" matches="[]," callbackexpect="!invert;" go="" through="" array,="" saving="" items="" pass="" validator="" callbackinverse="!callback(elems[" (callbackinverse="" callbackexpect)="" matches.push(elems[="" matches;="" arg="" map:="" arg)="" translating="" new="" values="" arg);="" ret.push(value);="" every="" object,="" elems)="" flatten="" any="" nested="" concat.apply([],="" ret);="" guid="" counter="" guid:="" 1,="" bind="" context,="" optionally="" partially="" applying="" arguments.="" proxy:="" (fn,="" context)="" args,="" proxy,="" tmp;="" (typeof="" "string")="" tmp="fn[" fn="tmp;" quick="" check="" determine="" target="" callable,="" spec="" this="" throws="" typeerror,="" but="" will="" just="" undefined.="" (!jquery.isfunction(fn))="" undefined;="" simulated="" 2);="" proxy="function" ()="" fn.apply(context="" this,="" args.concat(slice.call(arguments)));="" };="" set="" unique="" handler="" same="" original="" handler,="" it="" can="" be="" removed="" proxy.guid="fn.guid" =="" fn.guid="" jquery.guid++;="" proxy;="" now:="" +(="" date()="" jquery.support="" not="" core="" other="" projects="" attach="" needs="" exist.="" support="" });="" populate="" class2type="" map="" jquery.each("boolean="" number="" string="" array="" date="" regexp="" object="" error".split("="" "),="" (i,="" "[object="" "="" name="" "]"="" isarraylike(obj)="" type="jQuery.type(obj);" (type="==" jquery.iswindow(obj))="" false;="" (obj.nodetype="==" length)="" true;="" "array"="" "number"=""> 0 && ( length - 1 ) in obj;
    }
...
// Optimize for push.apply( _, NodeList )
            try {
                ...
                // Support: Android<4.0 1="" 8="" 9="" detect="" silently="" failing="" push.apply="" arr[="" preferreddoc.childnodes.length="" ].nodetype;="" }="" catch="" (e)="" {="" push="{" apply:="" arr.length="" ?="" leverage="" slice="" if="" possible="" function="" (target,="" els)="" push_native.apply(target,="" slice.call(els));="" :="" support:="" ie<9="" otherwise="" append="" directly="" var="" j="target.length," i="0;" can't="" trust="" nodelist.length="" while="" ((target[j++]="els[i++]))" target.length="j" -="" 1;="" };="" sizzle(selector,="" context,="" results,="" seed)="" match,="" elem,="" m,="" nodetype,="" qsa="" vars="" i,="" groups,="" old,="" nid,="" newcontext,="" newselector;="" ((="" context="" context.ownerdocument="" ||="" preferreddoc="" )="" !="=" document)="" setdocument(context);="" document;="" results="results" [];="" (!selector="" typeof="" selector="" "string")="" return="" results;="" ((nodetype="context.nodeType)" &&="" nodetype="" 9)="" (documentishtml="" !seed)="" shortcuts="" ((match="rquickExpr.exec(selector)))" speed-up:="" sizzle("#id")="" ((m="match[1]))" (nodetype="==" elem="context.getElementById(m);" check="" parentnode="" to="" when="" blackberry="" 4.6="" returns="" nodes="" that="" are="" no="" longer="" in="" the="" document="" (jquery="" #6963)="" (elem="" elem.parentnode)="" handle="" case="" where="" ie,="" opera,="" and="" webkit="" items="" by="" name="" instead="" of="" id="" (elem.id="==" m)="" results.push(elem);="" else="" is="" not="" a="" (context.ownerdocument="" contains(context,="" elem)="" elem.id="==" sizzle("tag")="" (match[2])="" push.apply(results,="" context.getelementsbytagname(selector));="" sizzle(".class")="" support.getelementsbyclassname="" context.getelementsbyclassname)="" context.getelementsbyclassname(m));="" path="" (support.qsa="" (!rbuggyqsa="" !rbuggyqsa.test(selector)))="" nid="old" =="" expando;="" newcontext="context;" newselector="nodeType" selector;="" works="" strangely="" on="" element-rooted="" queries="" we="" can="" work="" around="" this="" specifying="" an="" extra="" root="" working="" up="" from="" there="" (thanks="" andrew="" dupont="" for="" technique)="" ie="" doesn't="" object="" elements="" context.nodename.tolowercase()="" "object")="" groups="tokenize(selector);" ((old="context.getAttribute("id")))" "\\$&");="" context.setattribute("id",="" nid);="" +="" "']="" ";="" (i--)="" groups[i]="nid" toselector(groups[i]);="" testcontext(context.parentnode)="" context;="" (newselector)="" try="" newcontext.queryselectorall(newselector)="" );="" (qsaerror)="" finally="" (!old)="" context.removeattribute("id");="" all="" others="" select(selector.replace(rtrim,="" "$1"),="" seed);="" **="" *="" create="" key-value="" caches="" limited="" size="" @returns="" {function(string,="" object)}="" data="" after="" storing="" it="" itself="" with="" property="" (space-suffixed)="" string="" (if="" cache="" larger="" than="" expr.cachelength)="" deleting="" oldest="" entry="" createcache()="" keys="[];" cache(key,="" value)="" use="" (key="" "="" ")="" avoid="" collision="" native="" prototype="" properties="" (see="" issue="" #157)="" (keys.push(key=""> Expr.cacheLength) {
                ...
                pseudos: {
                    ...
                    "text": function (elem) {
                        ...
                        return elem.nodeName.toLowerCase() === "input" &&
                            ...
                            // Support: IE<8 0="" 1="" new="" html5="" attribute="" values="" (e.g.,="" "search")="" appear="" with="" elem.type="==" "text"="" (="" (attr="elem.getAttribute("type"))" =="null" ||="" attr.tolowercase()="==" );="" },="" position-in-collection="" "first":="" createpositionalpseudo(function="" ()="" {="" return="" [="" ];="" }),="" "last":="" (matchindexes,="" length)="" length="" -="" "eq":="" length,="" argument)="" argument="" <="" ?="" +="" :="" "even":="" var="" i="0;" for="" (;="" length;="" matchindexes.push(i);="" }="" matchindexes;="" "odd":="" "lt":="" argument;="" --i="">= 0;) {
                            matchIndexes.push(i);
                        }
                        return matchIndexes;
                    }),
                    ...
                    if (list) {
                        jQuery.each(arguments, function (_, arg) {
                            ...
                            while (( index = jQuery.inArray(arg, list, index) ) > -1) {
                                ...
                                if (firing) {
                                    if (index <= firinglength)="" {="" firinglength--;="" }="" if="" (index="" <="firingIndex)" firingindex--;="" });="" return="" this;="" },="" check="" a="" given="" callback="" is="" in="" the="" list.="" no="" argument="" given,="" whether="" or="" not="" list="" has="" callbacks="" attached.="" has:="" function="" (fn)="" fn="" ?="" jquery.inarray(fn,="" list)=""> -1 : !!( list && list.length );
                },
                ...
                if ((!special._default || special._default.apply(eventPath.pop(), data) === false) &&
                    ...
                    if (ontype && elem[ type ] && !jQuery.isWindow(elem)) {
                        ...
                        try {
                            ...
                            // IE<9 dies="" on="" focus="" blur="" to="" hidden element="" (#1486,#12518)="" only="" reproducible="" winxp="" ie8="" native,="" not="" ie9="" in="" mode="" }="" jquery.event.triggered="undefined;" if="" (tmp)="" {="" elem[="" ontype="" ]="tmp;" return="" event.result;="" },="" dispatch:="" function="" (event)="" make="" a="" writable="" jquery.event="" from="" the="" native="" event="" object="" var="" i,="" ret,="" handleobj,="" matched,="" j,="" handlerqueue="[]," args="slice.call(arguments)," handlers="(" jquery._data(this,="" "events")="" ||="" {}="" )[="" event.type="" [],="" special="jQuery.event.special[" {};="" use="" fix-ed="" rather="" than="" (read-only)="" args[0]="event;" event.delegatetarget="this;" call="" predispatch="" hook="" for="" mapped="" type,="" and="" let="" it="" bail="" desired="" (special.predispatch="" &&="" special.predispatch.call(this,="" event)="==" false)="" return;="" determine="" event,="" handlers);="" run="" delegates="" first;="" they="" may="" want="" stop="" propagation="" beneath="" us="" i="0;" while="" ((matched="handlerQueue[" i++="" ])="" !event.ispropagationstopped())="" event.currenttarget="matched.elem;" j="0;" ((handleobj="matched.handlers[" j++="" !event.isimmediatepropagationstopped())="" triggered="" must="" either="" 1)="" have="" no="" namespace,="" or="" 2)="" namespace(s)="" subset="" equal="" those="" bound="" (both="" can="" namespace).="" (!event.namespace_re="" event.namespace_re.test(handleobj.namespace))="" event.handleobj="handleObj;" event.data="handleObj.data;" ret="(" (jquery.event.special[="" handleobj.origtype="" {}).handle="" handleobj.handler="" )="" .apply(matched.elem,="" args);="" (ret="" !="=" undefined)="" ((event.result="ret)" =="=" event.preventdefault();="" event.stoppropagation();="" postdispatch="" type="" (special.postdispatch)="" special.postdispatch.call(this,="" event);="" handlers:="" (event,="" handlers)="" sel,="" matches,="" delegatecount="handlers.delegateCount," cur="event.target;" find="" delegate="" black-hole="" svg="" <use=""> instance trees (#13180)
                ...
                while ((name = attrNames[i++])) {
                    ...
                    if (jQuery.expr.match.bool.test(name)) {
                        ...
                        if (getSetInput && getSetAttribute || !ruseDefault.test(name)) {
                            elem[ propName ] = false;
                            // Support: IE<9 0="" 7="" also="" clear="" defaultchecked="" defaultselected="" (if="" appropriate)="" }="" else="" {="" elem[="" jquery.camelcase("default-"="" +="" name)="" ]="elem[" propname="" see="" #9699="" for="" explanation="" of="" this="" approach="" (setting="" first,="" then="" removal)="" jquery.attr(elem,="" name,="" "");="" elem.removeattribute(getsetattribute="" ?="" name="" :="" propname);="" },="" attrhooks:="" type:="" set:="" function="" (elem,="" value)="" if="" (!support.radiovalue="" &&="" value="==" "radio"="" jquery.nodename(elem,="" "input"))="" setting="" the="" type="" on="" a="" radio="" button="" after="" resets="" in="" ie6-9="" reset="" to="" default case="" is="" set="" during="" creation="" var="" val="elem.value;" elem.setattribute("type",="" value);="" (val)="" elem.value="val;" return="" value;="" });="" hook="" boolean="" attributes="" boolhook="{" value,="" (value="==" false)="" remove="" when="" false="" jquery.removeattr(elem,="" name);="" (getsetinput="" getsetattribute="" ||="" !rusedefault.test(name))="" ie<8="" needs="" *property*="" elem.setattribute(!getsetattribute="" jquery.propfix[="" use="" and="" oldie="" name;="" };="" retrieve="" booleans="" specially="" jquery.each(jquery.expr.match.bool.source.match(="" \w+="" g),="" (i,="" getter="attrHandle[" jquery.find.attr;="" attrhandle[="" !rusedefault.test(name)="" isxml)="" ret,="" handle;="" (!isxml)="" avoid="" an="" infinite="" loop by="" temporarily="" removing="" from="" handle="attrHandle[" ];="" ret="getter(elem," !="null" name.tolowercase()="" null;="" ret;="" fix="" attroperties="" (!getsetinput="" !getsetattribute)="" jquery.attrhooks.value="{" (jquery.nodename(elem,="" does="" not="" so="" that="" setattribute="" used="" elem.defaultvalue="value;" nodehook="" defined="" (#1954);="" otherwise="" fine="" nodehook.set(elem,="" ie6="" do="" support="" getting="" some="" with="" get="" (!getsetattribute)="" any="" attribute="" fixes="" almost="" every="" issue="" existing="" or="" create="" new="" node="" (!ret)="" elem.setattributenode(="" (ret="elem.ownerDocument.createAttribute(name))" );="" ret.value="value" ;="" break="" association="" cloned="" elements="" using="" (#9646)="" (name="==" "value"="" elem.getattribute(name))="" are="" constructed="" empty-string="" values="" attrhandle.id="attrHandle.name" =="" attrhandle.coords="function" ""="" fixing="" retrieval="" requires="" module="" jquery.valhooks.button="{" get:="" ret.specified)="" ret.value;="" nodehook.set="" contenteditable="" removals(#10429)="" empty="" string="" throws="" error="" as="" invalid="" jquery.attrhooks.contenteditable="{" width="" height="" auto="" instead="" string(="" bug="" #8150="" )="" removals="" jquery.each([="" "width",="" "height"="" ],="" jquery.attrhooks[="" "")="" elem.setattribute(name,="" "auto");="" (!support.style)="" jquery.attrhooks.style="{" (elem)="" undefined="" note:="" ie="" uppercases="" css="" property="" names,="" but="" we="" were="" .tolowercase()="" .csstext,="" would="" destroy="" senstitivity="" url's,="" like="" "background"="" elem.style.csstext="" undefined;="" (="" rfocusable="/^(?:input|select|textarea|button|object)$/i," rclickable="/^(?:a|area)$/i;" jquery.fn.extend({="" prop:="" (name,="" access(this,="" jquery.prop,="" arguments.length=""> 1);
        },
...
// Attach a bunch of functions for handling common AJAX events
    ...
    jQuery.expr.filters.hidden = function (elem) {
        ...
        if (jQuery.isArray(a) || ( a.jquery && !jQuery.isPlainObject(a) )) {
            ...
            // If traditional, encode the " old"="" way="" (the="" 1.3.2="" older="" did="" it),="" otherwise="" params="" recursively.="" (prefix="" a)="" a[="" prefix="" the="" resulting="" serialization="" s.join("&").replace(r20,="" "+");="" jquery.fn.extend({="" serialize:="" ()="" jquery.param(this.serializearray());="" },="" serializearray:="" this.map(function="" can="" prophook="" "elements"="" to="" filter="" "elements");="" jquery.makearray(elements)="" this;="" })="" .filter(function="" type="this.type;" use="" .is(":disabled")="" so="" that="" fieldset[disabled]="" works="" this.name="" !jquery(this).is(":disabled")="" rsubmittable.test(this.nodename)="" !rsubmittertypes.test(type)="" this.checked="" !rcheckabletype.test(type)="" .map(function="" elem)="" val="jQuery(this).val();" jquery.isarray(val)="" jquery.map(val,="" (val)="" name:="" elem.name,="" value:="" val.replace(rcrlf,="" "\r\n")="" }).get();="" create="" request="" (this="" still="" attached="" ajaxsettings="" backward="" compatibility)="" jquery.ajaxsettings.xhr="window.ActiveXObject" !="=" undefined="" support:="" ie6+="" xhr="" cannot="" access="" local="" files,="" always="" activex="" case="" !this.islocal="" ie7-8="" oldie="" does="" not="" support="" non-rfc2616="" methods="" (#13240)="" see="" http:="" msdn.microsoft.com="" en-us="" library="" ie="" ms536648(v="vs.85).aspx" www.w3.org="" protocols="" rfc2616="" rfc2616-sec9.html#sec9="" although="" this="" check="" six="" instead="" eight="" since="" also="" "trace"="" "connect"="" ^(get|post|head|put|delete|options)$="" i.test(this.type)="" createstandardxhr()="" createactivexhr();="" all="" other="" browsers,="" standard="" xmlhttprequest="" createstandardxhr;="" xhrid="0," xhrcallbacks="{}," xhrsupported="jQuery.ajaxSettings.xhr();" ie<10="" open requests="" must="" be="" manually="" aborted="" unload="" (#5280)="" (window.activexobject)="" jquery(window).on("unload",="" (var="" xhrcallbacks)="" xhrcallbacks[="" ](undefined,="" true);="" determine="" properties="" support.cors="!!xhrSupported" "withcredentials"="" =="" !!xhrsupported;="" transport="" browser="" provide="" (xhrsupported)="" jquery.ajaxtransport(function="" (options)="" cross="" domain="" only="" allowed="" supported="" through="" (!options.crossdomain="" support.cors)="" callback;="" send:="" (headers,="" complete)="" i,="" id="++xhrId;" socket="" xhr.open(options.type,="" options.url,="" options.async,="" options.username,="" options.password);="" apply="" custom="" fields="" provided="" (options.xhrfields)="" (i="" options.xhrfields)="" xhr[="" ];="" override="" mime="" needed="" (options.mimetype="" xhr.overridemimetype)="" xhr.overridemimetype(options.mimetype);="" x-requested-with="" header="" cross-domain="" requests,="" seeing="" conditions="" preflight="" are="" akin="" jigsaw="" puzzle,="" we="" simply="" never="" sure.="" (it="" per-request="" basis="" even="" using="" ajaxsetup)="" same-domain="" won't="" change="" already="" provided.="" !headers["x-requested-with"])="" headers["x-requested-with"]="XMLHttpRequest" ;="" headers="" headers)="" ie<9="" ie's="" activexobject="" throws="" 'type="" mismatch'="" exception="" when="" setting="" null-value.="" keep="" consistent="" with="" implementations,="" cast="" ignore="" `undefined`.="" (headers[="" undefined)="" xhr.setrequestheader(i,="" headers[="" "");="" do="" send="" may="" raise="" which="" actually="" handled="" jquery.ajax="" (so="" no="" try="" catch="" here)="" xhr.send((="" options.hascontent="" options.data="" null);="" listener="" callback="function" (_,="" isabort)="" status,="" statustext,="" responses;="" was="" called="" complete="" (callback="" isabort="" xhr.readystate="==" ))="" clean="" up="" delete="" xhr.onreadystatechange="jQuery.noop;" abort="" (isabort)="" (xhr.readystate="" 4)="" xhr.abort();="" responses="{};" status="xhr.status;" accessing="" binary-data="" responsetext="" (#11426)="" (typeof="" xhr.responsetext="==" "string")="" responses.text="xhr.responseText;" firefox="" statustext="" faulty="" (e)="" normalize="" webkit="" giving="" empty="" non="" behaviors="" have="" data:="" assume="" success="" (success="" data="" get="" notified,="" that's="" best="" given="" current="" implementations)="" (!status="" options.islocal="" !options.crossdomain)="" 404;="" -="" #1450:="" sometimes="" returns="" should="" (status="==" 1223)="" call="" (responses)="" complete(status,="" responses,="" xhr.getallresponseheaders());="" (!options.async)="" we're="" sync="" mode="" fire="" callback();="" (ie6="" &="" ie7)="" it's="" cache="" has="" been="" retrieved="" directly="" need="" settimeout(callback);="" list="" active="" callbacks="" abort:="" (callback)="" callback(undefined,="" functions="" xhrs="" new="" window.xmlhttprequest();="" createactivexhr()="" window.activexobject("microsoft.xmlhttp");="" install="" script="" datatype="" jquery.ajaxsetup({="" accepts:="" script:="" "text="" javascript,="" application="" ecmascript,="" x-ecmascript"="" contents:="" (?:java|ecma)script="" converters:="" script":="" (text)="" jquery.globaleval(text);="" text;="" handle="" cache's="" special="" global="" jquery.ajaxprefilter("script",="" (s)="" (s.cache="==" s.cache="false;" (s.crossdomain)="" s.type="GET" s.global="false;" bind="" tag="" hack="" jquery.ajaxtransport("script",="" deals="" script,="" head="document.head" jquery("head")[0]="" document.documentelement;="" callback)="" script.async="true;" (s.scriptcharset)="" script.charset="s.scriptCharset;" script.src="s.url;" attach="" handlers="" browsers="" script.onload="script.onreadystatechange" (isabort="" !script.readystate="" loaded|complete="" .test(script.readystate))="" memory="" leak="" null;="" remove="" (script.parentnode)="" script.parentnode.removechild(script);="" dereference="" (!isabort)="" callback(200,="" "success");="" circumvent="" ie6="" bugs="" base="" (#2709="" #4378)="" by="" prepending="" native="" dom="" manipulation="" avoid="" our="" dommanip="" ajax="" trickery="" head.insertbefore(script,="" head.firstchild);="" (script)="" script.onload(undefined,="" oldcallbacks="[]," rjsonp="/(=)\?(?=&|$)|\?\?/;" default jsonp="" settings="" jsonp:="" "callback",="" jsonpcallback:="" jquery.expando="" "_"="" nonce++="" this[="" detect,="" options="" jquery.ajaxprefilter("json="" jsonp",="" (s,="" originalsettings,="" jqxhr)="" callbackname,="" overwritten,="" responsecontainer,="" jsonprop="s.jsonp" false="" rjsonp.test(s.url)="" "url"="" s.data="==" "string"="" !(="" s.contenttype="" ).indexof("application="" x-www-form-urlencoded")="" rjsonp.test(s.data)="" "data"="" iff="" expected="" "jsonp"="" parameter="" (jsonprop="" s.datatypes[="" "jsonp")="" name,="" remembering="" preexisting="" associated="" callbackname="s.jsonpCallback" jquery.isfunction(s.jsonpcallback)="" s.jsonpcallback()="" s.jsonpcallback;="" insert="" url="" (jsonprop)="" ].replace(rjsonp,="" "$1"="" callbackname);="" (s.jsonp="" false)="" s.url="" rquery.test(s.url)="" "&"="" "?"="" s.jsonp="" json"]="function" (!responsecontainer)="" jquery.error(callbackname="" called");="" responsecontainer[="" force="" json="" overwritten="window[" window[="" responsecontainer="arguments;" clean-up="" (fires="" after="" converters)="" jqxhr.always(function="" restore="" save="" back="" free="" (s[="" ])="" make="" sure="" re-using="" doesn't="" screw="" things="" around="" s.jsonpcallback="originalSettings.jsonpCallback;" future="" oldcallbacks.push(callbackname);="" response="" (responsecontainer="" jquery.isfunction(overwritten))="" overwritten(responsecontainer[="" ]);="" undefined;="" delegate="" "script";="" html="" context="" (optional):="" specified,="" fragment="" will="" created="" context,="" defaults="" document="" keepscripts="" true,="" include="" scripts="" passed="" jquery.parsehtml="function" (data,="" keepscripts)="" (!data="" "boolean")="" document;="" parsed="rsingleTag.exec(data)," [];="" single="" (parsed)="" [="" context.createelement(parsed[1])="" scripts);="" (scripts="" scripts.length)="" jquery(scripts).remove();="" jquery.merge([],="" parsed.childnodes);="" copy="" old="" load="" method="" _load="jQuery.fn.load;" **="" *="" page="" jquery.fn.load="function" (url,="" params,="" _load)="" _load.apply(this,="" arguments);="" selector,="" response,="" type,="" self="this," off="url.indexOf("" ");="" (off="">= 0) {
