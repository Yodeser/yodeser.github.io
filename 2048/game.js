...
function gameover() {
    alert("gameover!");
    $("#grid-container").append("<div id="gameover" class="gameover"><p>本次得分</p><span>" + score + "</span><a href="javascript:restartgame();" id="restartgamebutton" target="_blank" rel="noopener">Restart</a></div>");
